import svgPaths from "./svg-ddnr0dkbd5";
...
function BillingInfoContainer() {
  return (
    <div className="content-stretch flex gap-[17.942px] items-start px-[32px] py-[24px]" data-name="Billing Info Container">
      <BilledByContainer />
      <BilledToContainer />
    </div>
  );
...
function InvoiceTitleContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative flex-1" data-name="Invoice Title Container">
      <InvoiceTitleWrapper />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex items-center justify-between pl-[24px] pr-[32px] h-[70px] w-full">
...
function HeaderContent() {
  return (
    <div className="content-stretch flex flex-col items-end w-full px-[32px] pb-[29.9px]" data-name="Header Content">
      <Frame1 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="bg-[#fbfcfe] flex flex-col w-full pt-[24px] pb-[0px]">
      <Frame2 />
      <Frame3 />
    </div>
  );
...
function ItemsContainer() {
  return (
    <div className="mx-[32px] rounded-[5.981px] relative" data-name="Items Container">
...
function PaymentInfoContainer() {
  return (
    <div className="content-stretch flex gap-[23.922px] items-center mx-[32px] w-[386px] self-end" data-name="Payment Info Container">
      <SummaryContainer />
    </div>
  );
}
...
export default function Page() {
  return (
    <div className="bg-white flex flex-col pb-[32px] w-full" data-name="Page 3">
      {/* Grey header block */}
      <Frame4 />
      {/* Edge-to-edge divider */}
      <div className="w-full shrink-0" style={{ borderBottom: "0.748px solid #D0D5DD" }} />
      {/* White background sections */}
      <div className="flex flex-col gap-[29.903px]">
