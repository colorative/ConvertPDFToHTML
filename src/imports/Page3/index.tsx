...
function BillingInfoContainer() {
  return (
    <div className="content-stretch flex gap-[17.942px] items-start relative shrink-0 w-full pt-[24px]" data-name="Billing Info Container">
      <BilledByContainer />
      <BilledToContainer />
    </div>
  );
...
function HeaderContainer() {
  return (
    <div
      className="bg-[#fbfcfe] flex flex-col relative shrink-0"
      style={{ marginLeft: "-32px", width: "calc(100% + 64px)" }}
      data-name="Header Container"
    >
      {/* Invoice title + logos row */}
      <div className="flex items-center justify-between pl-[24px] pr-[32px] h-[70px]">
        <InvoiceTitleContainer />
        <EventInfoContainer1 />
      </div>
      {/* Event info + invoice details */}
      <div className="px-[32px]">
        <Frame1 />
      </div>
      {/* Edge-to-edge divider */}
      <div className="w-full mt-[29.903px]" style={{ borderBottom: "0.748px solid #D0D5DD" }} />
      {/* Billed By / Billed To */}
      <div className="px-[32px]">
...
function Frame() {
  return (
    <div className="absolute bg-[#fbfcfe] content-stretch flex items-center justify-between left-0 right-0 pl-[24px] pr-[32px] top-0 h-[70px]">
      <InvoiceTitleContainer />
      <EventInfoContainer1 />
    </div>
  );
...
function Frame2() {
  return (
    <div className="absolute h-[70px] left-0 right-0 top-0 w-full">
      <div className="absolute bg-[#fbfcfe] h-[70px] inset-x-0 top-0" />
      <Frame />
    </div>
  );
}
...
export default function Page() {
  return (
    <div className="bg-white flex flex-col gap-[29.903px] items-end pb-[32px] px-[32px] relative w-full" data-name="Page 3">
      <HeaderContainer />
      <ItemsContainer />
